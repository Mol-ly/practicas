...
3=Triángulo, 4=Cuadrilátero, 5=Pentágono, 6=Hexágono. Si el número no está en la lista, 
...
rl.question('Ingrese el número de lados de la figura (3, 4, 5, 6): ', (lados) => {
    switch (lados) {
        case '3':
            console.log('Triángulo');
            break;
        case '4':
            console.log('Cuadrilátero');
            break;
        case '5':
